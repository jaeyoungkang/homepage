...
<div class="intent-visual aspect-verdict" role="img" aria-label="POL aspect가 pointcut sites에 적용되고 alpha coverage와 beta wovenness를 모두 통과해야 met가 되는 흐름">
  <div class="aspect-source"><span>POL-XXX-NNN</span><strong>aspect / advice</strong><em>공통 규칙</em></div>
  <div class="aspect-sites"><span>pointcut sites</span><strong>US-A AC · US-B AC · US-C AC</strong><em>적용 대상 전체</em></div>
  <div class="aspect-check alpha"><span>α Coverage</span><strong>모든 site가 advice를 따르는가?</strong><em>누락 site가 있으면 not-met</em></div>
  <div class="aspect-check beta"><span>β Wovenness</span><strong>advice가 약속 형식 안에 박혀 있는가?</strong><em>코드에만 있으면 not-met</em></div>
  <div class="aspect-and"><span>α ∧ β</span><strong>둘 다 green</strong></div>
  <div class="aspect-met"><span>POL §5 Verdict</span><strong>met</strong><em>covering spec에 기록</em></div>
</div>
